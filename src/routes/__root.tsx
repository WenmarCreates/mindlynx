...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "NexPrime RCM — Behavioral Health Billing Specialists" },
      ...
      { name: "author", content: "NexPrime RCM" },
      { property: "og:title", content: "NexPrime RCM — Behavioral Health Billing Specialists" },
